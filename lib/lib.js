...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./ajax */ "./src/ajax.js"), __webpack_require__(/*! ./component */ "./src/component.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (exports, _ajax, _component) {
  "use strict";
  ...
  var ComponentRegistry = function () {
    function ComponentRegistry(logger, uri) {
    ...
    _createClass(ComponentRegistry, [{
      key: "loadComponentDefinitions",
      value: function loadComponentDefinitions(uri) {
        _ajax2.default.get(uri).then(this.setComponentDefinitions.bind(this)).catch(this.handleError.bind(this));
      }
    }, {
      key: "setComponentDefinitions",
      value: function setComponentDefinitions(componentData) {
        this.componentDefinitions = JSON.parse(componentData);
        if (this.logger) this.logger.logInfo("Component registry loaded:", this.componentDefinitions);
        this.loadComponents();
      }
    }, {
      key: "handleError",
      value: function handleError(errorMessage) {
        if (this.logger) this.logger.logError("Registry Error: Load components:", errorMessage);
      }
    }, {
      key: "loadComponents",
      value: function loadComponents() {
        for (var componentName in this.componentDefinitions) {
          var componentUri = this.componentDefinitions[componentName];
          var component = new _component2.default(this.logger, componentName, componentUri);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./ajax */ "./src/ajax.js"), __webpack_require__(/*! tinybind */ "./node_modules/tinybind/dist/tinybind.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (exports, _ajax, _tinybind) {
  "use strict";
  ...
  var _tinybind2 = _interopRequireDefault(_tinybind);
  ...
  var Component = function () {
    function Component(logger, name, uri) {
      _classCallCheck(this, Component);

      this.name = name;
      this.uri = uri;
      this.logger = logger;
      if (this.logger) this.logger.logInfo("Component initialized", this);
      this.onCreate();
    }
    ...
    _createClass(Component, [{
      ...
      value: function onCreate() {
        var uri = this.uri;
        var definitionUrl = uri + "/definition.json";
        var templateHtmlUrl = uri + "/template.html";
        var templateCssUrl = uri + "/template.css";
        Promise.all([_ajax2.default.get(definitionUrl).then(this.parseComponentDefinition.bind(this)), _ajax2.default.get(templateHtmlUrl).then(this.storeTemplateHtmlData.bind(this)), _ajax2.default.get(templateCssUrl).then(this.storeTemplateCssData.bind(this))]).then(this.onRender.bind(this)).catch(this.handleError.bind(this));
      }
    }, {
      key: "onRender",
      value: function onRender() {
        this.dereferenceDocumentElements();
        if (this.logger) this.logger.logInfo("Component rendered", this.name);
      }
    }, {
      key: "dereferenceDocumentElements",
      value: function dereferenceDocumentElements() {
        var documentElements = document.getElementsByTagName(this.name);
        var pageData = window.pageData;

        for (var elemIdx = 0; elemIdx < documentElements.length; elemIdx++) {
          var element = documentElements[elemIdx];
          var elemData = this.dereferenceElementData(pageData, element, this.definition.interface);
          this.injectTemplateData(element, elemData, this.templateData);
        }
      }
    }, {
      key: "parseComponentDefinition",
      value: function parseComponentDefinition(componentDefinition) {
        return new Promise(function (resolve, reject) {
      ...
      key: "storeTemplateHtmlData",
      value: function storeTemplateHtmlData(templateData) {
        return new Promise(function (resolve, reject) {
      ...
      key: "storeTemplateCssData",
      value: function storeTemplateCssData(cssData) {
        return new Promise(function (resolve, reject) {
      ...
      value: function handleError(errorMessage) {
        ...
        if (logger) logger.logError("Component Error: OnLoad:", errorMessage);
      }
    }, {
      key: "dereferenceElementData",
      value: function dereferenceElementData(pageData, element, elementInterface) {
        var elemData = {};

        for (var attrIdx = elementInterface.length - 1; attrIdx >= 0; attrIdx--) {
          var elemAttrName = this.snakeToCamelCase(elementInterface[attrIdx]);
          var elemAttrValue = this.dereferenceElementValue(pageData, element, elemAttrName);
      ...
      key: "dereferenceElementValue",
      value: function dereferenceElementValue(pageData, element, elemAttrName) {
        var elemValue = element.dataset[elemAttrName];
        if (elemValue.indexOf("pageData.") !== 0) return elemValue;
        var pageDataAttrName = elemValue.replace("pageData.", "");
        if (!pageDataAttrName in pageData) return "";
        return pageData[pageDataAttrName];
      }
    }, {
      key: "injectTemplateData",
      value: function injectTemplateData(element, elemData, elemTemplate) {
        var elemSelector = "mu-" + this.name;
        this.injectComponentHtml(element, elemTemplate, elemSelector);
        var bindableElems = document.querySelectorAll('[data-type=\'' + elemSelector + '\']');

        for (var elemIdx = bindableElems.length - 1; elemIdx >= 0; elemIdx--) {
          var elem = bindableElems[elemIdx];

          _tinybind2.default.bind(elem, elemData);
        }
      }
    }, {
      key: "injectComponentHtml",
      value: function injectComponentHtml(element, elemTemplate, elemSelector) {
        var newElement = this.parseHtml(elemTemplate);
        this.cloneAttributes(element, newElement);
        newElement.setAttribute("data-type", elemSelector);
        var cssElement = this.parseHtml("<style></style>");
      ...
      key: "cloneAttributes",
      value: function cloneAttributes(element, newElement) {
        var elemAttributes = element.attributes;

        for (var attrIdx = elemAttributes.length - 1; attrIdx >= 0; attrIdx--) {
          var attribute = elemAttributes.item(attrIdx);
          if (attribute.name.indexOf("data-") != 0) newElement.setAttribute(attribute.name, attribute.value);
        }
      }
    }, {
      key: "snakeToCamelCase",
      value: function snakeToCamelCase(str) {
      ...
      key: "parseHtml",
      value: function parseHtml(htmlString) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./logger */ "./src/logger.js"), __webpack_require__(/*! ./component-registry */ "./src/component-registry.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (exports, _logger, _componentRegistry) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.Muta = undefined;
  ...
  function main() {
    ...
    var registryUri = window.pageData.registry;
    var registry = new _componentRegistry2.default(logger, registryUri);
    logger.endMutaGroup();
  }

  main();
  var Muta = exports.Muta = {
    Logger: _logger2.default,
    ComponentRegistry: _componentRegistry2.default
  };
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var Logger = function () {
    ...
    _createClass(Logger, [{
      key: "initializeLogActive",
      value: function initializeLogActive() {
        var logActive = true;
        ...
        this.activateLog = function () {
          logActive = true;
        };

        this.deactivateLog = function () {
          logActive = false;
        };
      }
    }, {
      key: "initializeGroupStarted",
      value: function initializeGroupStarted() {
        var groupStarted = false;

        this.isGroupStarted = function () {
          return groupStarted;
        };

        this._startGroup = function () {
          groupStarted = true;
        };

        this._endGroup = function () {
          groupStarted = false;
        };
      }
    }, {
      key: "startMutaGroup",
      value: function startMutaGroup() {
      ...
      key: "logError",
      value: function logError(title, errorMsg) {
        if (!this.isActive()) return;
        if (!this.isGroupStarted()) this.startMutaGroup();
        console.warn("%c" + title, "color: #e74c3c;", errorMsg);
      }
    }, {
      key: "logInfo",
      value: function logInfo(title, infoMsg) {
        if (!this.isActive()) return;
        if (!this.isGroupStarted()) this.startMutaGroup();
