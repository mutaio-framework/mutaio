  ...
  var Component = function () {
    ...
    _createClass(Component, [{
      ...
      value: function onCreate() {
        ...
        var templateUrl = uri + "/template.html";
        Promise.all([_ajax2.default.get(definitionUrl).then(this.parseComponentDefinition.bind(this)), _ajax2.default.get(templateUrl).then(this.storeTemplateData.bind(this))]).then(this.onRender.bind(this)).catch(this.handleError.bind(this));
      }
    }, {
      key: "onRender",
      ...
      value: function onDestroy() {
        ...
        if (this.logger) this.logger.logInfo("Component destroyed", this.name);
      }
    }, {
      ...
      key: "storeTemplateData",
      value: function storeTemplateData(templateData) {
        return new Promise(function (resolve, reject) {
      ...
      value: function injectTemplateData(element, elemData, elemTemplate) {
        var elemId = elemData["id"];
        var newElement = this.parseHtml(elemTemplate);
        newElement.setAttribute("id", elemId);
        element.outerHTML = newElement.outerHTML; //const elemSelector 	= "#" + elemId;

        var bindableElem = document.getElementById(elemId);
        console.log("Binding to", bindableElem);

        _tinybind2.default.bind(bindableElem, elemData);
      }
    }, {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function main() {
    ...
    var registry = new _componentRegistry2.default(logger, "./demo-registry.json");
    logger.endMutaGroup();
  }
